...
const menuApi: AssetMenuApi = {
  ...
  onNewFsm: (dir) => void assetActions.doNewFsm(dir),
  onNewBehaviorTree: (dir) => void assetActions.doNewBehaviorTree(dir),
  onOpenLogic: (item) => itemActions.openLogicAsset(item),
