...
export const MCP_TOOLS: { name: string; description: string }[] = [
  ...
  { name: "asset.create", description: "新建资源文件或目录（type: scene/script/material/shader/texcube/folder；dir 目标目录；name 名称；shader 可带 shaderKind: physical/unlit/toon/custom）" },
