...
function clampHex(v, fb) {
  const n = typeof v === "number" && Number.isFinite(v) ? v : fb;
  return Math.min(16777215, Math.max(0, Math.round(n))) & 16777215;
}
...
function _sampleHeightAt(h, n, size, wx, wz) {
  ...
  return (h[iz * n + ix] * (1 - tx) + h[iz * n + ix + 1] * tx) * (1 - tz) + (h[(iz + 1) * n + ix] * (1 - tx) + h[(iz + 1) * n + ix + 1] * tx) * tz;
}
...
function createTerrain(json) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n;
  const settings = parseSettings(json.terrain);
  const ms = json.materialSettings ?? null;
  const ts = ms ? {
    ...settings,
    grassColor: ((_b = (_a = ms.layers) == null ? void 0 : _a[0]) == null ? void 0 : _b.color) ?? settings.grassColor,
    rockColor: ((_d = (_c = ms.layers) == null ? void 0 : _c[1]) == null ? void 0 : _d.color) ?? settings.rockColor,
    snowColor: ((_f = (_e = ms.layers) == null ? void 0 : _e[2]) == null ? void 0 : _f.color) ?? settings.snowColor
  } : settings;
  const splatmap = ms ? {
    data: null,
    width: 0,
    height: 0,
    layerColors: [
      ((_h = (_g = ms.layers) == null ? void 0 : _g[0]) == null ? void 0 : _h.color) ?? 7238227,
      ((_j = (_i = ms.layers) == null ? void 0 : _i[1]) == null ? void 0 : _j.color) ?? 7563871,
      ((_l = (_k = ms.layers) == null ? void 0 : _k[2]) == null ? void 0 : _l.color) ?? 15330544,
...
async function applyTerrainSplatmaps(terrains) {
  await Promise.all(
    terrains.map(async (entry) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
      const ms = (_a = entry.json) == null ? void 0 : _a.materialSettings;
      const rel = ms == null ? void 0 : ms.splatmap;
      ...
      const layerColors = [
        ((_c = (_b = ms.layers) == null ? void 0 : _b[0]) == null ? void 0 : _c.color) ?? 7238227,
        ((_e = (_d = ms.layers) == null ? void 0 : _d[1]) == null ? void 0 : _e.color) ?? 7563871,
        ((_g = (_f = ms.layers) == null ? void 0 : _f[2]) == null ? void 0 : _g.color) ?? 15330544,
        ((_i = (_h = ms.layers) == null ? void 0 : _h[3]) == null ? void 0 : _i.color) ?? 16777215
      ];
      const splatmap = {
      ...
      const mat = (_j = terrainGroup.children[0]) == null ? void 0 : _j.material;
      if (!mat) return;
...
function createTerrains(entries) {
  var _a;
  const byId = /* @__PURE__ */ new Map();
  for (const e of entries) {
    const id = typeof ((_a = e.json) == null ? void 0 : _a.id) === "string" ? e.json.id : "";
    if (id) byId.set(id, e);
  }
  return {
