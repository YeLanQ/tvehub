import { Loader, LoaderUtils, FileLoader, SRGBColorSpace, LinearSRGBColorSpace, BufferGeometry, BufferAttribute, InterleavedBuffer, InterleavedBufferAttribute, Color, ColorManagement, CompressedCubeTexture, CompressedArrayTexture, CompressedTexture, LinearFilter, LinearMipmapLinearFilter, NoColorSpace, RGBA_PVRTC_2BPPV1_Format, RGBA_PVRTC_4BPPV1_Format, RGBA_BPTC_Format, RED_GREEN_RGTC2_Format, SIGNED_RED_GREEN_RGTC2_Format, RED_RGTC1_Format, SIGNED_RED_RGTC1_Format, RGBA_S3TC_DXT5_Format, RGB_S3TC_DXT1_Format, RGBA_S3TC_DXT1_Format, RGBA_ASTC_6x6_Format, RGBA_ASTC_4x4_Format, SIGNED_RG11_EAC_Format, RG11_EAC_Format, SIGNED_R11_EAC_Format, R11_EAC_Format, RGB_ETC2_Format, RGBA_ETC2_EAC_Format, RGBFormat, RedFormat, RGFormat, RGBAFormat, UnsignedByteType, HalfFloatType, UnsignedInt101111Type, UnsignedInt5999Type, UnsignedShortType, FloatType, DataTexture, Data3DTexture, NearestMipmapNearestFilter, NearestFilter, RGB_PVRTC_4BPPV1_Format, RGB_ETC1_Format, RGB_BPTC_UNSIGNED_Format } from "../../core/three.module.min.js";
const _taskCache$1 = /* @__PURE__ */ new WeakMap();
const WASM_BIN_URL$1 = "../libs/draco/draco_decoder.wasm";
const WASM_JS_URL$1 = "../libs/draco/draco_wasm_wrapper.js";
...
const NORMALIZED_VK_FORMATS = /* @__PURE__ */ new Set([Ue]);
const FORMAT_MAP = {
  [Ae]: RGBAFormat,
  [de]: RGFormat,
  [ye]: RedFormat,
...
var MeshoptDecoder = (function() {
  ...
  var instance;
  var ready2 = WebAssembly.instantiate(wasm, {}).then(function(result) {
...
let ktx2Loader = null;
let lastRenderer;
function setupCompressedGltfSupport(setup) {
  if (!dracoLoader) {
  ...
  try {
    ktx2Loader ?? (ktx2Loader = new KTX2Loader().setTranscoderPath(setup.basisBase));
    ktx2Loader.detectSupport(setup.renderer);
  } catch (e) {
    ktx2Loader = null;
    console.warn("[gltf] KTX2 解码不可用（压缩纹理将无法解析）:", e);
  }
}
function applyCompressedGltfSupport(loader) {
...
function withCompressedGltf(loader) {
  ensureSetup();
