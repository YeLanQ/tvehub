...
// 运行：pnpm smoke logic-runtime
// ---------------------------------------------------------------------------

import { createSuite, installDomShim, engineURL as engine } from "../harness.mjs";

const { ok: okStd, finish } = createSuite();
const ok = (label, cond) => okStd(cond, label);
