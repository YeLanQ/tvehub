...
// 普通材质（PBR/Unlit/卡通/自定义等着色器引用）绝不能被判成天空材质
...
const PLAIN_MATS: [string, string][] = [
  ...
  ["项目自定义着色器引用", mat({ shader: "assets/shaders/MyEffect.shader", props: { _Speed: 1 } })],
